...
public class AdsGenerationService {
    ...
    /**
     * Generate ads content. In production, this would call the external ads generation API.
     */
    private String generatedAdsContent(String prompt) {
        return """
                ...
                **Ad Variation 2 (TikTok):**
                "Did you know? Our solution saves 50% of your time! Check out how it works: [Link]"
